...
public class TestSymmetric4testfortimeonly implements BWAPIEventListener  {
	...
	public static void main(String[] args) throws Exception{
		...
		TestSymmetric4testfortimeonly tc=new TestSymmetric4testfortimeonly();
...
////////IN BETWEEN SET EXPERIMENTS///////////////////////////////////////////////////////////
	...
	public void evo_vs_nokav_testonly(){
		Player p1= new Player_Evolution_timeTest(0);
		Player_Evolution_timeTest pe = (Player_Evolution_timeTest) p1;
		pe.init6scripts();
	...
	private void ensureUnitNumSetting(Player p,int i){
		...
		if(p instanceof Player_Evolution_timeTest){
			Player_Evolution_timeTest pw = (Player_Evolution_timeTest) p;
			pw.setNumUnit(i);
		}
