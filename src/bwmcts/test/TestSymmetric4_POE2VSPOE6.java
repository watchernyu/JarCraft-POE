...
public class TestSymmetric4_POE2VSPOE6 implements BWAPIEventListener  {
	...
	int[] numOfUnitsInTest =  new int[]{48,4,8,16,32,64,96};

	int totalRuns = 50;
	
	public static void main(String[] args) throws Exception{
		System.out.println("Create TC instance");
		TestSymmetric4_POE2VSPOE6 tc=new TestSymmetric4_POE2VSPOE6();
