...
public class Player_POE_final_no_cross extends Player {
	//Portfolio Online Evolution player with no crossover implemented
	...
	public Player_POE_final_no_cross(int playerID) {
		firstTimeInit=true;
		_id = playerID;
		setID(playerID);
	...
	public void init2scripts(){
		...
		//scripts.add(new Player_Kite(_id));
	...
	public void getMoves(GameState state, HashMap<Integer, List<UnitAction>> moves, List<UnitAction> moveVec) {
		...
		if(firstTimeInit){
			...
			//for the first time
			P = new Population_final(this,state,futureSteps,numOfScripts,numOfUnits,scripts);
			P.initialize();
