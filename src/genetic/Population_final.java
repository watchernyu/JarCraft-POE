...
public class Population_final {
	...
	public Population_final(Player player,GameState state,int futureSteps, int numOfScripts,int numOfUnits,ArrayList<Player> scripts) {
		this.state = state;
		this.generation = 0;
	...
	public void setTimeLimit(long ns){
		TIMELIMIT = ns;
	}
